 ...
 */
UserRouter.get('/me', passport_1.default.authenticate('jwt', { session: false }), userController.getMe);
/**
 * @swagger
 * /users/withdraw:
 *   delete:
 ...
 *         description: 존재하지 않는 사용자입니다
 */
UserRouter.delete('/withdraw', passport_1.default.authenticate('jwt', { session: false }), userController.withdraw);
/**
 * @swagger
 ...
 */
UserRouter.put('/:id', (0, middleware_1.validateDto)(dtos_1.UserUpdateRequestDto), userController.updateUser);
/**
 * @swagger
 * /users/{id}:
 *   delete:
